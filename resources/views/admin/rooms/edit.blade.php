...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="d-flex align-items-center mb-4">
            ...
            <h2 class="admin-title mb-0">Chỉnh sửa phòng: <span class="text-primary">{{ $room->name }}</span></h2>
        </div>
                ...
                <form action="{{ route('admin.rooms.update', $room->id) }}" method="POST">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-8">
                            ...
                            <input type="text" name="name" class="form-control form-control-lg @error('name') is-invalid @enderror" value="{{ old('name', $room->name) }}">
                    ...
                    <div class="mb-5 p-3 bg-light rounded-3 border">
                        <div class="form-check form-switch d-flex align-items-center">
                            <input class="form-check-input mt-0 me-3" type="checkbox" role="switch" name="status" id="status" {{ $room->status ? 'checked' : '' }}>
                            <label class="form-check-label fw-bold" for="status" style="cursor: pointer;">Phòng đang hoạt động (Bật để cho phép đặt phòng)</label>
                        </div>
                    </div>
