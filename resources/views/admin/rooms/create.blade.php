...
<div class="row justify-content-center py-4">
    <div class="col-md-9">
        <div class="d-flex align-items-center mb-4">
            ...
            <h2 class="text-white text-uppercase fw-bold mb-0" style="letter-spacing: 1px;">Thêm Phòng Mới</h2>
        </div>
            ...
            <div class="card-body">
                <form action="{{ route('admin.rooms.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" class="form-control form-control-lg luxury-input @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="VD: Phòng họp Signature A1">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6 mb-3 mb-md-0">
                            ...
                            <div class="input-group input-group-lg">
                                <input type="number" name="price" class="form-control luxury-input @error('price') is-invalid @enderror" value="{{ old('price', 0) }}" min="0" step="1000">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group input-group-lg">
                                <input type="number" name="capacity" class="form-control luxury-input @error('capacity') is-invalid @enderror" value="{{ old('capacity') }}" placeholder="0">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="description" class="form-control luxury-input" rows="4" placeholder="Nhập các trang thiết bị có trong phòng (Máy chiếu, Bảng trắng...)">{{ old('description') }}</textarea>
                    </div>

                    <div class="mb-5 p-4 rounded-4" style="background-color: #1a1a1c; border: 1px solid rgba(255,255,255,0.1);">
                        <div class="form-check form-switch d-flex align-items-center">
                            <input class="form-check-input mt-0 me-3" type="checkbox" role="switch" name="status" id="status" value="1" checked style="transform: scale(1.5); cursor: pointer;">
                            <label class="form-check-label fw-bold text-white fs-5" for="status" style="cursor: pointer;">Cho phép đặt phòng ngay lập tức</label>
                        </div>
                    </div>
